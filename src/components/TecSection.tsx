...
const TecSection = () => {
  return (
    <section
      className="md:h-[100vhd]  flex flex-col bg-[#140C28] md:bg-cover md:bg-center px-5 py-10 md:p-0"
    ...
    >
      <div className='flex xl:py-10 py-5 flex-col items-center justify-center bg-center bg-[url("./assets/Tecs_icons/tec_bg/bg-desktop.png")] md:bg-none '>
        <div className="flex flex-row items-center py-10 xl:py-12.5">
        ...
        <div className="flex flex-col items-center justify-center xl:scale-90 md:flex-row md:w-[90%] xl:w-[85%] xxl:scale-100 flex-wrap gap-5 xl:pb-20 lg:gap-y-12.5">
          {tecData.map((item) => (
            <MiniCard
              key={item.id}
              icon={item.icon}
