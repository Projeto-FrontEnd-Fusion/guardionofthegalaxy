...
import { star, Bg } from '../shared/constants/Tec_images';
  ...
  return (
    ...
    >
      <div className='flex xl:py-10 py-5 flex-col items-center justify-center bg-center bg-[url("./assets/Tecs_icons/tec_bg/bg-desktop.png")] md:bg-none '>
        ...
        <div className="flex flex-col items-center justify-center xl:scale-90 md:flex-row md:w-[90%] xl:w-[85%] flex-wrap gap-5 lg:gap-y-12.5">
          {tecData.map((item) => (
            <MiniCard
              key={item.id}
              icon={item.icon}
