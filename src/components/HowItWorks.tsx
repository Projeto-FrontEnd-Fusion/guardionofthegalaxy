...
export default function HowItWorks() {
  return (
    <section
      className="py-20 px-4 bg-cover bg-center bg-no-repeat h-screen flex flex-col items-center justify-center"
    ...
    >
      <section>
        <div className="flex flex-row items-center justify-center gap-3 mb-12 w-full">
          ...
          <h2 className="text-xl md:text-2xl font-bold tracking-wide !text-white block font-sans">
            Como funciona
          </h2>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 max-w-5xl w-full mx-auto">
          {steps.map((step) => (
            <div
              key={step.id}
              className="flex flex-col items-start p-5 bg-[#0F0B1F] border-2 border-fuchsia-600/40 rounded-xl backdrop-blur-md hover:border-fuchsia-500 transition-all duration-300 min-h-[220px] w-full max-w-[220px]"
            >
